...
-- Listage des données de la table bookshelf_corner.books : ~8 rows (environ)
/*!40000 ALTER TABLE `books` DISABLE KEYS */;
INSERT INTO `books` (`ID`, `title`, `created_at`, `author`, `notation`, `catchphrase`, `id_genre`, `content`, `picture`, `year_publication`, `slider`) VALUES
	(1, 'Lord of the Ring', '2022-03-10 15:36:55', 'J.R.R. Tolkien', 3, '       Une odyssée au coeur du Mordor', 2, '       Trop cool ce livre', '025.png', '1982', '0'),
...
-- Listage des données de la table bookshelf_corner.genres : ~6 rows (environ)
...
-- Listage des données de la table bookshelf_corner.messages : ~17 rows (environ)
...
INSERT INTO `messages` (`id`, `gender`, `familyname`, `firstname`, `send_at`, `email`, `object`, `message`) VALUES
	...
	(70, 'male', 'je', 'pl', '2022-05-03 19:27:46', 'ciyu@tu.k', 'Réclamation', 'ees'),
	(71, 'female', 'fe', 'error', '2022-05-03 19:27:55', 'agnes@youhou.com', 'Réclamation', 'iù'),
	(72, 'other', 'fe', 'pl', '2022-05-03 19:28:04', 'Louis@co.k', 'Accès à mes données', 'ùjpjù'),
	(73, 'female', 'jpù', 'pùj', '2022-05-03 19:28:14', 'ciyu@tu.k', 'Réclamation', 'ùjio'),
	(74, 'male', 'fe', 'Héle', '2022-05-03 19:38:05', 'toto@gmail.com', 'Réclamation', 'y_uo:y oim i'),
	(75, 'female', 'prat', 'Muriel', '2022-05-03 19:38:14', 'Louis@co.k', 'Réclamation', 'my_èyu');
...
-- Listage des données de la table bookshelf_corner.website : ~1 rows (environ)
