    ...
    foreach($datas as $data){ 
        ...
        <article class="flex">
            ...
            <div class="flex comment-link">
                <a title="Lire ce commentaire" href="indexAdmin.php?action=commentView&id=<?=$data['id']; ?>" class="stretched-link"><i class="fa-solid fa-eye"></i></a>
          ...
          <div id="myModal<?= $data['id']; ?>" class="modal display-none">
            <div class="modal-content text-center">
                ...
                <div class="flex justify-center">
                    ...
                    <a href="indexAdmin.php?action=commentDelete&id=<?= $data['id'];?>" title="Supprimer ce commentaire" class="btn center">Supprimer</a>
                </div>
            </div>
        </div>
