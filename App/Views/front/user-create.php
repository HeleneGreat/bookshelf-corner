...
<section class="container text-center bg-contact">
    ...
    <form action="index.php?action=createUserPost" method="post" enctype='multipart/form-data'>
        <p><input type="text" name="userPseudo" id="pseudo" placeholder="Votre pseudo"><span class="required" pattern="^[a-zA-Z0-9]{5,}$" title="Votre pseudo doit contenir au moins 5 caractère et n'accepte pas les caractères spéciaux">*</span></p>
