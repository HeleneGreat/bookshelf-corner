...
<section id="user-connexion" class="container text-center">
    ...
    <form action="index.php?action=connexionUserPost" method="post">
        ...
        <input type="email" name="userMail" id="mail" placeholder="Votre adresse e-mail" value=""></p>
        <p><label class="display-none" for="mdp">Mot de passe</label>
        <input type="password" name="userMdp" id="mdp" placeholder="Votre mot de passe" value=""></p>
